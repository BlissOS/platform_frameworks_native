...
void CursorInputMapper::sync(nsecs_t when, nsecs_t readTime) {
    ...
    if (mSource != AINPUT_SOURCE_MOUSE_RELATIVE) {
    ...
    if (downChanged || moved || scrolled || buttonsChanged) {
        ...
        } else if (down || (mSource == AINPUT_SOURCE_MOUSE_RELATIVE)) {
        ...
        if (motionEventAction == AMOTION_EVENT_ACTION_UP && (mSource != AINPUT_SOURCE_MOUSE_RELATIVE)) {
